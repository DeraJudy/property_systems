...
//         Property not found. Check your ID and Table names.
//       </div>
//     );
...
//                 <a
//                   href={getFileUrl(cert.document_url)}
//                   target="_blank"
...
//                 <div
//                   key={job.id}
//                   className="flex items-center justify-between p-3 border rounded-lg border-[#e1dbd2]"
//                 >
//                   <div className="flex items-center gap-3">
//                     <Wrench className="text-blue-500 h-5 w-5" />
//                     <div>
//                       <p className="font-semibold text-[#123d2b]">
//                         {job.title || "Repair Task"}
//                       </p>
//                       <p className="text-sm text-muted-foreground">
//                         {job.description}
//                       </p>
...
//                 <div
//                   key={doc.id}
//                   className="flex items-center justify-between p-4 border rounded-xl border-[#e1dbd2]"
//                 >
//                   <div className="flex items-center gap-3">
//                     <FileText className="text-[#1f6b4a] h-5 w-5" />
//                     <span className="font-medium text-[#123d2b]">
//                       {doc.file_name}
//                     </span>
//                   </div>
//                   <a
//                     href={doc.file_url}
//                     target="_blank"
//                     className="p-2 text-[#1f6b4a] hover:bg-[#e6f2ec] rounded-full"
//                   >
...
// // const STORAGE_URL =
// //   "https://simsrcdfubslrakfujmq.supabase.co/storage/v1/object/public/property-documents/";

//   const STORAGE_URL = "https://simsrcdfubslrakfujmq.supabase.co/storage/v1/object/public/property-documents/";
