        ...
        <div className="relative flex flex-1 items-center justify-center p-12">
          ...
          >
            ...
            <p className="mb-8 text-[#f7f2e9]/80 leading-relaxed">
              Set up your organisation in minutes. Invite your team, add
              properties, and streamline your supported housing operations.
            </p>
            <div className="space-y-3">
              {[
                ...
                >
                  <div className="flex h-5 w-5 items-center justify-center rounded-full bg-[#f7f2e9]/20">
                    <svg
                      className="h-3 w-3 text-[#f7f2e9] "
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                      strokeWidth={3}
                  ...
                  <span className="text-sm text-[#f7f2e9]/90">{item}</span>
                </motion.div>
              ))}
            </div>
          </motion.div>
        ...
        >
          ...
          <form className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Building className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 muted-foreground-text" />
                <Input
                  id="org"
