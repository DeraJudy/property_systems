    ...
    <div className="min-h-screen p-4 md:p-8">
      ...
      <div className="max-w-5xl mx-auto mb-6 flex items-center justify-between">
        <Button
          variant="ghost"
          onClick={() => router.back()}
          className="text-[#123d2b] hover:bg-[#e1dbd2] transition-all flex items-center gap-2 px-4 group"
        >
          <ArrowLeft className="h-4 w-4 group-hover:-translate-x-1 transition-transform" /> 
          <span className="font-semibold">Back to Dashboard</span>
        </Button>
        <div className="hidden md:flex items-center gap-2 text-xs font-bold text-[#1f6b4a] uppercase tracking-widest bg-white/50 px-4 py-2 rounded-full border border-[#e1dbd2]">
          <ShieldCheck className="w-3.5 h-3.5" /> Secure Data Entry
        </div>
      </div>

      <Card className="max-w-5xl mx-auto border-[#e1dbd2] shadow-2xl bg-white/80 backdrop-blur-sm overflow-hidden">
        {/* Modern Gradient Header */}
        <CardHeader className="bg-[#123d2b] text-white p-6 md:p-10">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              <CardTitle className="text-2xl md:text-3xl font-bold flex items-center gap-3">
                <div className="p-2 bg-[#1f6b4a] rounded-lg">
                  <Home className="w-6 h-6 text-white" />
                </div>
                Property Onboarding
              </CardTitle>
              <p className="text-[#e1dbd2] mt-2 text-sm md:text-base opacity-90">
            ...
            <div className="bg-white/10 px-4 py-3 rounded-xl border border-white/20 backdrop-blur-md">
              <span className="text-[10px] uppercase font-bold text-[#e1dbd2] block mb-1">Status</span>
        ...
        <CardContent className="p-6 md:p-10">
          <form onSubmit={handleSubmit} className="space-y-10">
            <Tabs defaultValue="basic" className="w-full">
              <TabsList className="grid grid-cols-2 md:grid-cols-4 bg-[#f1ede4] p-1 rounded-xl h-auto mb-8">
                {[
                  ...
                  <TabsTrigger 
                    key={tab.value}
                    value={tab.value} 
                    className="data-[state=active]:bg-white data-[state=active]:text-[#123d2b] data-[state=active]:shadow-sm py-3 rounded-lg flex items-center gap-2 transition-all font-semibold text-sm"
                  >
              ...
              {/* BASIC TAB */}
              <TabsContent value="basic" className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-500">
                <div className="space-y-6">
                  <div className="flex items-center gap-3">
                    <div className="h-8 w-1.5 bg-[#1f6b4a] rounded-full" />
                    <h3 className="text-[#123d2b] text-lg font-bold">Property Location & Image</h3>
                  </div>

                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="md:col-span-1">
                      <Label className="mb-3 block text-sm font-bold text-[#123d2b] uppercase tracking-wider">
                        Primary Photo
                      </Label>
                      <div
                      ...
                      ${imagePreview ? "border-transparent" : "border-[#e1dbd2] bg-[#fbf8f2] hover:border-[#1f6b4a] hover:bg-[#f1ede4]"}`}
                        onClick={() =>
                      ...
                      >
                        {imagePreview ? (
                          ...
                          <div className="text-center p-6">
                            <div className="bg-[#1f6b4a]/10 p-4 rounded-full inline-block mb-3">
                              <ImageIcon className="w-10 h-10 text-[#1f6b4a]" />
                            </div>
                            <p className="text-[#123d2b] font-bold text-sm">Drop property photo</p>
                    ...
                    <div className="md:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-5">
                      <div className="space-y-2 col-span-2">
                        <Label className="text-[#123d2b] font-semibold flex items-center gap-2">
                           <Home className="w-3.5 h-3.5" /> Property Name
                        </Label>
                        <Input
                          required
                          placeholder="e.g. Oakwood Manor"
                          className="bg-[#f7f3eb] border-[#e1dbd2] focus:ring-2 focus:ring-[#1f6b4a] focus:bg-white h-12 transition-all"
                      ...
                      <div className="space-y-2">
                        <Label className="text-[#123d2b] font-semibold">City</Label>
                        <Input
                          placeholder="City"
                          className="bg-[#f7f3eb] border-[#e1dbd2] focus:ring-2 focus:ring-[#1f6b4a] focus:bg-white h-12 transition-all"
                          value={formData.city}
                      ...
                      <div className="space-y-2">
                        <Label className="text-[#123d2b] font-semibold">Postcode</Label>
                        <Input
                          placeholder="Postcode"
                          className="bg-[#f7f3eb] border-[#e1dbd2] focus:ring-2 focus:ring-[#1f6b4a] focus:bg-white h-12 transition-all uppercase"
              ...
              <TabsContent value="details" className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-500">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  <div className="space-y-2 col-span-1 sm:col-span-2">
                    <Label className="text-[#123d2b] font-semibold">Parent Organisation</Label>
                    <Select
                      value={formData.organisationId}
                      onValueChange={(val) =>
                  ...
                  <div className="space-y-2">
                    <Label className="text-[#123d2b] font-semibold">Operational Status</Label>
                    <Select
                  ...
                  <div className="space-y-2">
                    <Label className="text-[#123d2b] font-semibold">Total Capacity (Rooms)</Label>
                    <Input
                      type="number"
                      placeholder="0"
                  ...
                  <div className="space-y-2">
                    <Label className="text-[#123d2b] font-semibold">Monthly Yield (£)</Label>
                    <Input
                      type="number"
                      placeholder="0.00"
                      className="bg-[#f7f3eb] border-[#e1dbd2] h-12"
              ...
              <TabsContent value="compliance" className="space-y-10 animate-in fade-in slide-in-from-bottom-2 duration-500">
                <div className="space-y-6">
                  <div className="flex items-center justify-between border-b border-[#e1dbd2] pb-4">
                    <div className="flex items-center gap-3">
                       <div className="h-8 w-1.5 bg-[#1f6b4a] rounded-full" />
                       <h3 className="text-[#123d2b] text-lg font-bold">Safety Certificates</h3>
                    </div>
                    <Button
                      type="button"
                      onClick={addCertificate}
                      className="bg-[#1f6b4a] hover:bg-[#123d2b] h-10 px-4 rounded-full flex items-center gap-2 text-xs font-bold transition-all shadow-md"
                    >
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    {certificates.map((cert, index) => (
                      <div
                        key={cert.id}
                        className="grid grid-cols-1 md:grid-cols-3 gap-6 p-6 rounded-2xl border border-[#e1dbd2] bg-white hover:border-[#1f6b4a]/40 transition-colors relative shadow-sm"
                      >
                        <Button
                          type="button"
                          variant="ghost"
                        ...
                        <div className="space-y-2">
                          <Label className="text-xs font-bold text-[#123d2b] uppercase tracking-wider">Document Type</Label>
                          <Select
                            value={cert.type}
                            onValueChange={(val) => {
                        ...
                        <div className="space-y-2">
                          <Label className="text-xs font-bold text-[#123d2b] uppercase tracking-wider">Expiry Date</Label>
                          <Input
                            type="date"
                        ...
                        <div className="space-y-2">
                          <Label className="text-xs font-bold text-[#123d2b] uppercase tracking-wider">Upload Scan</Label>
                          <Input
                            type="file"
                            className="hidden"
                            accept=".pdf,.doc,.docx"
                          ...
                          <Label
                            htmlFor={`f-${cert.id}`}
                            className="flex items-center gap-3 bg-[#e8e1d6]/50 hover:bg-[#e8e1d6] px-4 py-2.5 rounded-xl cursor-pointer text-xs font-semibold text-[#123d2b] border border-[#d1c9bd] transition-all h-11"
                          >
                ...
                <div className="bg-[#e6f2ec]/60 p-8 rounded-3xl border border-[#1f6b4a]/10 backdrop-blur-sm">
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
                    {["leaseFile", "floorPlanFile", "insuranceFile"].map(
                      (f) => (
                        <div key={f} className="space-y-3">
                          <Label className="text-[10px] font-black uppercase tracking-[0.2em] text-[#1f6b4a]">
                            {f
                              .replace("File", "")
                          ...
                          <Label
                            htmlFor={f}
                            className="flex flex-col items-center justify-center gap-3 bg-white px-6 py-8 rounded-2xl cursor-pointer border-2 border-dashed border-[#d1c9bd] hover:border-[#1f6b4a] hover:bg-white transition-all shadow-sm group"
                          >
                            ...
                            <div className="text-center">
                               <p className="text-xs font-bold text-[#123d2b]">
                                 {formData[f] ? "Replace File" : "Upload Document"}
                               </p>
                               {formData[f] && (
                                 <p className="text-[10px] truncate w-32 text-[#1f6b4a] font-medium mt-1">
                                   {formData[f].name}
                                 </p>
                               )}
                            </div>
                    ...
                    maintenanceLogs.map((log, index) => (
                      ...
                      >
                        ...
                        <div className="space-y-3">
                          <Label className="text-xs font-bold text-[#123d2b] uppercase tracking-wider flex items-center gap-2">
                            ...
                            {["Normal", "Low", "Medium", "High", "Urgent"].map((p) => (
                              <button
                                ...
                                className={`px-4 py-2 rounded-full text-xs font-bold transition-all border ${
                                  log.priority === p 
                                  ? "bg-[#1f6b4a] text-white border-[#1f6b4a] shadow-md" 
                                  : "bg-[#f7f3eb] text-[#123d2b] border-[#e1dbd2] hover:bg-[#e1dbd2]"
                                }`}
                              >
                                {p}
                              </button>
                           ...
                           <div className="space-y-2">
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <Label 
                                  ...
                                  className="flex-1 flex items-center justify-center gap-2 bg-[#e8e1d6] h-11 rounded-xl cursor-pointer text-xs font-bold text-[#123d2b] hover:bg-[#d1c9bd] transition-all border border-[#c5beaf]"
                                >
            ...
            <div className="flex flex-col md:flex-row items-center gap-4 pt-4">
              <Button
                type="submit"
                disabled={loading}
                className="w-full md:flex-1 bg-[#1f6b4a] py-8 text-lg font-bold shadow-xl hover:bg-[#123d2b] transition-all hover:scale-[1.01] active:scale-[0.99] rounded-2xl"
              >
                {loading ? (
                  <div className="flex items-center gap-3">
      ...
      <div className="max-w-5xl mx-auto mt-8 text-center">
        <p className="text-gray-400 text-[10px] font-bold uppercase tracking-[0.3em]">
          Internal Asset Management System • v2.4.0
        </p>
      </div>
    </div>
  );
