...
export default function ViewServiceUser() {
  ...
  // --- (2) FINALIZE ENTRY (Fixes 400 Error) ---
  // --- FINAL FIXED VERSION ---
                ...
                <table className="w-full text-left">
                  <thead className="bg-slate-50 border-b">
                    <tr>
                      ...
                      <th className="p-4 text-[10px] font-black uppercase text-slate-500">
                        Attactment
                      </th><th className="p-4 text-[10px] font-black uppercase text-slate-500">
                        Video
                      </th>
    ...
    {viewingMedia && (
      <div className="w-full">
        {viewingMedia.match(/\.(mp4|webm|mov|ogg)$/) ? (
          <video src={viewingMedia} controls className="w-full rounded-lg" />
