        ...
        <div className="lg:col-span-8 xl:col-span-9">
          <Tabs defaultValue="overview" className="space-y-6">
            <TabsList className="bg-[#f1ede4] p-1 border border-[#e1dbd2]">
              <TabsTrigger value="overview" className="data-[state=active]:bg-[#123d2b] data-[state=active]:text-white">Overview</TabsTrigger>
              ...
              <Card className="border-[#e1dbd2]">
                ...
                <CardContent className="pt-6">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                        <DataField label="Current Room" value={user.assigned_room} />
