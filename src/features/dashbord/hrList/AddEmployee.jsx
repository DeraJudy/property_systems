...
//       {/* SECTION 3: QUALIFICATIONS (MULTI-UPLOAD) */}
//         <Card className="bg-[#fbf8f2] border-[#e1dbd2] shadow-sm">
...
//                     placeholder="e.g. NVQ Level 3 Health & Social Care"
//                   />
//                 </div>
//                 <div className="flex-1 space-y-2">
...
//       {/* SECTION 4: SUPERVISION HISTORY (MULTI-UPLOAD) */}
//         <Card className="bg-[#fbf8f2] border-[#e1dbd2] shadow-sm">
//           <CardHeader className="border-b border-[#e1dbd2] flex flex-row items-center justify-between">
//             <CardTitle className="text-[#123d2b] text-lg flex items-center gap-2">
...
//               <div key={index} className="grid grid-cols-1 md:grid-cols-4 gap-4 items-end bg-white p-3 border rounded-md">
//                 <div className="space-y-2">
//                   <Label>Session Name</Label>
//                   <Input 
//                     value={item.name} 
//                     onChange={(e) => updateListField('supervisions', index, 'name', e.target.value)}
//                     placeholder="e.g. February Supervision"
//                   />
//                 </div>
//                 <div className="space-y-2">
//                   <Label>Date</Label>
...
//       {/* SECTION 5: OTHER DOCUMENTS (MULTI-UPLOAD) */}
//       <Card className="bg-[#fbf8f2] border-[#e1dbd2] shadow-sm">
//           <CardHeader className="border-b border-[#e1dbd2] flex flex-row items-center justify-between">
//             <CardTitle className="text-[#123d2b] text-lg flex items-center gap-2">
