...
//       <Link href="/dashboard/support-logs">
...
//               </SelectTrigger>
//               <SelectContent>
//                 <SelectItem value="1">James Smith</SelectItem>
...
//                 <SelectItem value="john">John Davies</SelectItem>
//               </SelectContent>
//             </Select>
//           </div>
//           <div>
...
//                 <SelectItem value="moveout">Move-Out Preparation</SelectItem>
//                 <SelectItem value="incident">Incident Report</SelectItem>
//                 <SelectItem value="support">Support</SelectItem>
//                 <SelectItem value="roomCheck">Room Check</SelectItem>
...
//           <div className="mt-1 flex items-center gap-2 rounded-lg border border-dashed border-border p-6 text-sm text-muted-foreground cursor-pointer hover:bg-accent/30 transition-colors">
//             <Paperclip className="h-4 w-4" /> Drop files here or click to upload
//           </div>
//         </div>
//         <div>
//           <Label>Digital Signature</Label>
//           <div className="mt-1 flex items-center justify-center rounded-lg border border-dashed border-border p-6 h-24 text-sm text-muted-foreground">
...
// const SupportLogNewPage = () => {
//   // 1. State for conditional "Follow-up" date
//   const [showFollowUpDate, setShowFollowUpDate] = useState(false);

//   // 2. Generate Duration options (00:05 to 24:00)
...
//       initial="hidden"
//       animate="show"
//       className="space-y-6 max-w-3xl p-4"
//     >
//       <motion.div variants={item} className="flex items-center gap-4">
//         <Link href="/dashboard/support-logs">
//           <Button variant="ghost" size="icon">
...
//             {/* Conditional Follow-up Date Input */}
//             <AnimatePresence>
//               {showFollowUpDate && (
//                 <motion.div
...
//           <div className="flex gap-3 pt-2">
//             <Button className="bg-[#123d2b] hover:bg-[#1f6b4a] text-white">Save Log</Button>
//             <Link href="/dashboard/support-logs">
//               <Button variant="outline">Cancel</Button>
//             </Link>
//           </div>
...
// import { Checkbox } from "@/components/ui/checkbox";
// import { motion, AnimatePresence } from "framer-motion";
// import { ArrowLeft, FileText, Paperclip, Loader2, User } from "lucide-react";
...
//         const { data: serviceUser, error: suError } = await supabase
//           .from("service_users")
...
//           .from("support_documents") // Updated bucket name
...
//       initial="hidden"
//       animate="show"
//       className="space-y-6 max-w-3xl p-4 mx-auto"
//     >
//       <motion.div variants={item} className="flex items-center gap-4">
...
//                 <UserCircleIcon className="w-4 h-4" /> {serviceUserName || "Loading..."}
//               </div>
//             </div>
...
//               </div>
//               <p className="text-[10px] text-muted-foreground mt-1 uppercase italic">Logged in user</p>
//             </div>
...
//               <Input className="mt-1" type="time" value={formData.session_time} onChange={(e) => setFormData({...formData, session_time: e.target.value})} />
//             </div>
